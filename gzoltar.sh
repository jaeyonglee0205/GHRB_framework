...
cd "target/"
classes_to_debug=$(find . -iname "*.class" | sed -e 's/\//./g' | sed -e 's/\.class//g' | sed -e 's/\.\.//g')
# cd ..
# cd "test-classes"
# classes_to_debug_2=$(find . -iname "*.class" | sed -e 's/\//./g' | sed -e 's/\.class//g' | sed -e 's/\.\.//g')
# cd ..
# cd ..


# classes_to_debug="$classes_to_debug_1$classes_to_debug_2"
#cd ..
#cd ..

# run gzoltar

echo $classes_to_debug
# echo $src_classes_dir
